...
class OutageTest < MiniTest::Test
  ...
  def test_outage_less_than_one_day_dst
    ...
    expected_values = {}
    _test_measure('SFD_Successful_EnergyPlus_Run_TMY.osm', args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 10)
  end
  ...
  def test_outage_partial_one_day_dst
    args_hash = {}
    args_hash['otg_type'] = 'Partial'
    args_hash['otg_date'] = 'Jun 2'
    args_hash['otg_hr'] = 8
    args_hash['otg_len'] = 24
    expected_num_del_objects = {}
  ...
  def test_outage_one_day_dst_comfort
    args_hash = {}
  ...
  def test_outage_less_than_one_day_dst_mf
    ...
    expected_values = {}
    _test_measure('MF_Successful_EnergyPlus_Run_TMY_Appl_PV.osm', args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 5)
  end
  ...
  def test_outage_short_run_period
    ...
    expected_values = {}
    _test_measure('SFD_Successful_EnergyPlus_Run_AMY_PV_TwoDays.osm', args_hash, expected_num_del_objects, expected_num_new_objects, expected_values, 9)
  end
